...
public class UserServiceImpl implements UserService {
    ...
    public User find(String name) {
        logger.info("The implementation of UserService from subproject-01");
        return new User("The user('" + name + "') came from the implementation of UserService that locates in subproject-01");
    }
